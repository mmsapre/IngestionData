...
@Repository
public class MongoDbJobExecutionDao extends com.test.ingestion.repository.dao.AbstractMongoDbDao implements JobExecutionDao {
    ...
    public Set<JobExecution> findRunningJobExecutions(String jobName) {
        DBCursor instancesCursor = getCollection(com.test.ingestion.repository.dao.MongoDbJobInstanceDao.COLLECTION_NAME)
